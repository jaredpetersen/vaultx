...
func TestGetSecretReturnsSecret(t *testing.T) {
	...
	// Set up mock API
	apic := apimocks.API{}
	apic.On("Read", ctx, "/v1/secret/data/"+secretPath, token.ClientToken).Return(&res, nil)
...
func TestGetSecretReturnsErrorOnRequestFailure(t *testing.T) {
	...
	// Set up mock API
	apic := apimocks.API{}
	apic.On("Read", ctx, "/v1/secret/data/"+secretPath, token.ClientToken).Return(nil, resErr)
...
func TestUpsertSecretDoesNotReturnError(t *testing.T) {
	...
	// Set up mock API
	apic := apimocks.API{}
	apic.On("Write", ctx, "/v1/secret/data/"+secretPath, token.ClientToken, mock.MatchedBy(func(input interface{}) bool {
...
func TestUpsertSecretReturnsErrorOnRequestFailure(t *testing.T) {
	...
	// Set up mock API
	apic := apimocks.API{}
	apic.On("Write", ctx, "/v1/secret/data/"+secretPath, token.ClientToken, mock.Anything).Return(nil, resErr)
...
func TestUpsertSecretReturnsErrorOnInvalidResponseCode(t *testing.T) {
	...
	// Set up mock API
	apic := apimocks.API{}
	apic.On("Write", ctx, "/v1/secret/data/"+secretPath, token.ClientToken, mock.Anything).Return(&res, nil)
